 ...
 * @author lesimoes
 */
public class ExibirView extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExibirView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
